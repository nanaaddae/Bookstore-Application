...
// Program uses SQLite for data storage.
...
class customer_page extends JFrame
{
    ...
    customer_page()
    {
        ...
        JButton check_out = new JButton("Check out Book");
        ...
        search.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                int option = JOptionPane.showConfirmDialog(getParent(), message, "Enter in the name of the book you want to find", JOptionPane.OK_CANCEL_OPTION);
                ...
                if (option == JOptionPane.OK_OPTION)
                {
                    ...
                    try {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement("select * from Books WHERE name = ?");
                    ...
                    {
                        JOptionPane.showMessageDialog(null, "There are no books in the database right now  ");
                        ex.printStackTrace();
                    }
        ...
        check_out.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (option == JOptionPane.OK_OPTION)
                {
                    ...
                    String value1 = Book.getText();
                    String value2 = ID.getText();
                    Database data = new Database();
                    data.delete_book(value2,value1);
                }

                JOptionPane.showMessageDialog(null, "Thank you for checking out this book !");

            }
        });

        search.setBounds(325,200,155,40);
        quit.setBounds(325,275,155,40);
        check_out.setBounds(325,355,200,40);
        ...
        remove_book.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              //  String value2 = name.getText();
                ...
                int option = JOptionPane.showConfirmDialog(getParent(), message, "Enter in the ISBN for the book you are removing", JOptionPane.OK_CANCEL_OPTION);
